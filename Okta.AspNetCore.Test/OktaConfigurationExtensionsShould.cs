...
namespace Okta.AspNetCore.Test
{
    public class OktaConfigurationExtensionsShould
    {
        ...
        #region GetOktaWebApiOptions Tests
        ...
        public void UseDefaultAudienceWhenNotSpecified()
        {
            ...
            options.Audience.Should().Be(AspNet.Abstractions.OktaWebApiOptions.DefaultAudience);
        }
        ...
        public void UseDefaultAuthorizationServerIdWhenNotSpecified()
        {
            ...
            options.AuthorizationServerId.Should().Be(AspNet.Abstractions.OktaWebOptions.DefaultAuthorizationServerId);
        }
        ...
        #region GetOktaMvcOptions Tests
        ...
        [Fact]
        public void BindCallbackPathForMvc()
        {
            var configuration = BuildConfiguration(new Dictionary<string, string>
            {
                { "Okta:OktaDomain", ValidOktaDomain },
                { "Okta:CallbackPath", "/custom-callback" },
            });

            var options = configuration.GetOktaMvcOptions();

            options.CallbackPath.Should().Be("/custom-callback");
        }

        [Fact]
        public void UseDefaultCallbackPathWhenNotSpecified()
        {
            var configuration = BuildConfiguration(new Dictionary<string, string>
            {
                { "Okta:OktaDomain", ValidOktaDomain },
            ...
            options.CallbackPath.Should().Be(OktaDefaults.CallbackPath);
        }
        ...
        #region Default Configuration Section Name Tests
        ...
        #region Issuer Configuration Tests
        ...
        [Fact]
        public void BindIssuerWithOktaPreviewDomain()
        {
            var configuration = BuildConfiguration(new Dictionary<string, string>
            {
                { "Okta:Issuer", "https://dev-123456.oktapreview.com/oauth2/default" },
            });
